...
public class AppleHomePage extends BasePage {
	...
	@FindBy(xpath = "//h2[@class='rs-iteminfo-title']")
	private WebElement verifyProduct;

	@FindBy(css = "[class='rs-iteminfo-remove as-buttonlink']")
	private WebElement removeButton;

	@FindBy(css = "[class='rs-bag-header']")
	private WebElement verifyCartEmpty;
	...
	public void clickOnContinueShippingAddressButton() {
		scrollIntoView(continueShippingAddressButton);
	...
	public String verifyAddedProductAndColour() {
	...
	public String verifyCartIsEmpty() throws InterruptedException {
		Thread.sleep(3000);
		waitForElementClickable(verifyCartEmpty);
		return getText(verifyCartEmpty);
	}
}
